...
#ifndef PK_PANEL_CONTROL_H
#define PK_PANEL_CONTROL_H
...
#ifdef LINUX
class PKPanelControl : public PKCustomContainer
#else
class PKPanelControl : public PKCustomControl
#endif
{
public:
